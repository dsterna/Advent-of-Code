...
const App: React.FC = () => {
  ...
  intersection.forEach(elem => {
    if (elem.x + elem.y !== 0)
      if (Math.abs(elem.x) + Math.abs(elem.y) < lowestSum) {
        lowestSum = Math.abs(elem.x) + Math.abs(elem.y);
      }
  }
  )
  // console.log('trackarray1', firstTrack);
  // console.log('trackarray2', secondTrack);
  // console.log('intersection', intersection);
  console.log('lowest Sum', lowestSum);
